...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "Q2qQXtVwoBw2QpB7yhU0ubvby";
	public static final String REST_CONSUMER_SECRET = "REL9N95VXQbDPBBPLPKxaOJQc3bGVihB1q9kh15h9qQCPWb5vp";
	...
	public void sendTweet(String message, long replyID,  AsyncHttpResponseHandler handler) {
		String apiUrl = getApiUrl("statuses/update.json");
		// Can specify query string params directly or through RequestParams.
		RequestParams params = new RequestParams();
		params.put("status", message);
